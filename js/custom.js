...
// (La lógica del header ahora está en css/header-modern.css + script inline)
...
jQuery(window).on('load', function() {
    (function($) {
        ...
        if ($('.plans-carousel').length && !$('.plans-carousel').data('owl.carousel')) {
            serviceCarousel();
        }
    })(jQuery);
});
